        ...
        body: ListView(
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                ProductTextField(textTitle: 'Product Title',
                ...
                ProductTextField(
                    ...
                    textHint: 'Enter Products price : 0.0 ',
                ...
                ProductTextField(
                    ...
                    textHint: 'choice:jacket/tShirt/skirt/pant',
...
//    //****************** +add image to firebase***************************
    List<String> imagesURL =
        await _store.uploadProductImage(docID: productID, imageList: imageList);
